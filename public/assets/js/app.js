! function() {
    "use strict";
    var t, e, a, n, s, o = localStorage.getItem("language"),
        l = "en";
    ...
    window.onload = function() {
        ...
        function() {
            ...
            for (var t = document.getElementsByClassName("vertical-menu-btn"), a = 0; a < t.length; a++) t[a] && t[a].addEventListener("click", function(t) {
                t.preventDefault(), document.body.classList.toggle("sidebar-enable"), 992 <= window.innerWidth ? null == e ? null == document.body.getAttribute("data-sidebar-size") || "lg" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "lg") : "md" == e ? "md" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "md") : "sm" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "lg") : document.body.setAttribute("data-sidebar-size", "sm") : r()
            })
        }(), setTimeout(function() {
            ...
            var e, a, n, s, o, l, i = window.location.href.split(/[?#]/)[0];
            t.href == i && (t.classList.add("active"), (e = t.parentElement) && (e.classList.add("active"), (a = e.parentElement).classList.add("active"), (n = a.parentElement) && (n.classList.add("active"), (s = n.parentElement) && (s.classList.add("active"), (o = s.parentElement) && (o.classList.add("active"), (l = o.parentElement) && l.classList.add("active"))))))
        ...
        }(), a = document.getElementsByTagName("body")[0], (n = document.querySelectorAll(".light-dark")) && n.forEach(function(t) {
            t.addEventListener("click", function(t) {
                a.hasAttribute("data-layout-mode") && "dark" == a.getAttribute("data-layout-mode") ? (document.body.setAttribute("data-layout-mode", "light"), "vertical" == document.body.getAttribute("data-layout") && document.body.setAttribute("data-topbar", "light")) : (document.body.setAttribute("data-layout-mode", "dark"), "vertical" == document.body.getAttribute("data-layout") && document.body.setAttribute("data-topbar", "dark"))
            })
        }), a = document.body, document.getElementById("right-bar-toggle").addEventListener("click", function(t) {
        ...
        }), r(), (s = document.getElementById("checkAll")) && (s.onclick = function() {

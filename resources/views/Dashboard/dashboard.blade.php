      ...
      <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
              <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="javascript: void(0);">MR. Rapat</a></li>
          ...
          <div class="card-body">
              <div class="text-center py-3">
                 ...
                 <div class="main-wid position-relative">
                      <h3 class="text-white">MR. Rapat Dashboard</h3>

                      <h3 class="text-white mb-0"> Welcome, {{ session()->get('divisi') }}!</h3>

                      <p class="text-white-50 px-4 mt-4">Anda dapat melihat gambaran keseluruhan data yang ada pada aplikasi ini</p>
          ...
          <div class="col-lg-3 col-md-6">
              <div class="card">
                  <div class="card-body">
                      ...
                      <p class="text-muted mt-4 mb-0">Jumlah Rapat</p>
                      <h4 class="mt-1 mb-0"><a href="/rapat" style="color: rgb(82, 80, 80)">{{ $jml_rapat }}</a> <span class="text-success fw-medium font-size-14"> Rapat</span></h4>
                      <div>
                          <div class="py-3 my-1">
                              {{-- <div id="mini-1" data-colors='["#3980c0"]'></div> --}}
                          </div>
                          <ul class="list-inline d-flex justify-content-between justify-content-center mb-0">
                              <li class="list-inline-item"><a href="#" class="text-muted">All</a></li>
                          </ul>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="card-body">
                      <div class="avatar">
                          <span class="avatar-title bg-soft-success rounded">
                              <i class="mdi mdi-account-box-multiple text-success font-size-24"></i>
                          </span>
                      </div>
                      <p class="text-muted mt-4 mb-0">Jumlah Karyawan</p>
                      <h4 class="mt-1 mb-0"><a href="/karyawan/{{ session('divisi_id') }}" style="color: rgb(82, 80, 80)">{{ $jml_karyawan }}</a><span class="text-success fw-medium font-size-14"> Orang</span></h4>
                      <div>
                          <div class="py-3 my-1">
          ...
          <div class="col-lg-3 col-md-6">
              <div class="card">
                  <div class="card-body">
                      ...
                      <p class="text-muted mt-4 mb-0">Rencana Rapat </p>
                      <h4 class="mt-1 mb-0"><a href="/rapat" style="color: rgb(82, 80, 80)">{{ $rencana }}</a><span class="text-success fw-medium font-size-14"> Rapat</span></h4>
                      <div>
                          <div class="py-3 my-1">
          ...
          <div class="col-lg-3 col-md-6">
              <div class="card">
                  <div class="card-body">
                      ...
                      <p class="text-muted mt-4 mb-0">{{ (session('divisi_id') == 1)?'Jumlah Divisi': 'Rapat Terlaksana'}}</p>
                      @if(session('divisi_id') !== 1)
                        <h4 class="mt-1 mb-0"><a href="/rapat" style="color: rgb(82, 80, 80)">{{ $terlaksana }}</a><span class="text-success fw-medium font-size-14"> Rapat</span></h4>
                      @else 
                      <h4 class="mt-1 mb-0"><a href="#" style="color: rgb(82, 80, 80)">{{ $jml_divisi-1 }}</a><span class="text-success fw-medium font-size-14"> Divisi</span></h4>
                      @endif
                      <div>
                          <div class="py-3 my-1">
